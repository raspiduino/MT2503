...
typedef enum
{
    ...
    , EM_GSM_SEND_CCCH_DECODE_STATUS,
    EM_GSM_SEND_SACCH_DECODE_STATUS
...
#ifdef __JAMMING_DETECTION__
    kal_bool        is_bsic_bcch_info_valid;
    em_status_enum  bsic_status[200];
    em_status_enum  bcch_status[200];
#endif /* __JAMMING_DETECTION__ */
...
typedef struct
{
    kal_uint8         ref_count;
    kal_uint16        msg_len;
    em_blk_type_enum  channel;
    em_status_enum    status;
} l4cps_em_rd_blk_result_ind_struct;
#endif /* __JAMMING_DETECTION__ */
