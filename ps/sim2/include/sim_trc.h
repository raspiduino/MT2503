...
BEGIN_TRACE_MAP(MOD_SIM)
    ...
    TRC_MSG(WARNING_AUTHENTICATE_OPERATION_ERROR,"USIM_ERROR: GSM CONTEXT IN AUTHENTICATE NOT ALLOWED!")
    TRC_MSG(WARNING_USIM_CHANNEL_OPERATION_ERROR,"USIM_CHANNEL_ERROR: CHANNEL No OUT OF RANGE!")
    TRC_MSG(WARNING_INVALID_INS_OPERATION_ERROR,"INVALID INS NOT ALLOWED!")
