...
extern void l4cuem_audio_play_file_req(kal_uint64 volume, kal_wchar* file_name, kal_uint8 play_style, kal_uint8 output_path);
extern void l4cuem_audio_stop_file_req(void);
extern void l4cuem_set_audio_at_speech_info_req(kal_uint8 src_id,void *new_param);
#endif
