 ...
 *  void
 *****************************************************************************/
void l4cuem_audio_play_file_req(kal_uint64 volume, kal_wchar* file_name, kal_uint8 play_style, kal_uint8 output_path)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void l4cuem_audio_stop_file_req(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------*/
    kal_trace(TRACE_FUNC, FUNC_UEM_AUDIO_STOP);
    uem_send_msg_to_aud(MSG_ID_MEDIA_AUD_STOP_REQ);
}

/*****************************************************************************
 * FUNCTION
 *  l4cuem_set_audio_at_speech_info_req
 * DESCRIPTION
 *  
 * PARAMETERS
 *  src_id        [IN]  
 ...
 *  void
 *****************************************************************************/
void l4cuem_set_audio_at_speech_info_req(kal_uint8 src_id,void *new_param)
{
	uem_send_msg_to_aud(MSG_ID_MEDIA_AUD_SET_AT_AUDIO_SPEECH_INFO_REQ,(kal_uint32)src_id,new_param);
}
...
#ifdef __2G_MULTI_SLOT_TX_TEST_SUPPORT__
