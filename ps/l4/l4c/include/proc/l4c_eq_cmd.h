...
extern 	kal_bool l4c_eq_audio_stop_file_req(void);//wxw
extern kal_bool l4c_eq_audio_play_file_req(kal_uint64 volume, kal_wchar* file_name, kal_uint8 play_style, kal_uint8 output_path);//
#endif
...
extern kal_bool l4c_eq_get_mute_status_req(kal_uint8 src_id);
...
extern kal_uint32 l4c_read_nvram(kal_uint16 lid, kal_uint16 record, kal_uint8 *buffer);
extern kal_uint32 l4c_write_nvram(kal_uint16 lid, kal_uint16 record, kal_uint8 *buffer, kal_uint8 *nv_data);
extern kal_bool l4c_default_nvram(kal_uint16 lid);
