 ...
 * Filename:
 * ---------
 * custom_gprs_pdp_timer_config.h
 *
 * Project:
 * --------
 *   MAUI Project
...
#ifndef _CUSTOM_GPRS_PDP_TIMER_CONFIG_H
#define _CUSTOM_GPRS_PDP_TIMER_CONFIG_H

#include "kal_general_types.h"
#include "kal_non_specific_general_types.h"

/* See custom_gprs_pdp_timer_config.c for the usage. */
...
#endif /* _CUSTOM_GPRS_PDP_TIMER_CONFIG_H */ 
