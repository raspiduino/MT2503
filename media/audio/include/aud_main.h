...
extern void aud_set_speech_info_req_hdlr(ilm_struct *ilm_ptr);
#endif
...
extern void aud_audio_get_mute_status_req_hdlr(ilm_struct *ilm_ptr);
...
extern void aud_keytone_detect_start(void);
extern void aud_keytone_detect_stop(void);
