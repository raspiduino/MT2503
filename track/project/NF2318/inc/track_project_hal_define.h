...
//152看门狗
#define WATCH_DOG_GPIO  27
#define HEAD_LIGHT_GPIO  47
#define ELE_LOCK_GPIO	42 ///电门锁，电源输入控制
#define ROSE_GATE_OPEN_GPIO 29//开涨闸锁
#define ROSE_GATE_CLOSE_GPIO 3 //关涨闸锁

#define ELE_SWT_ON_GPIO  28//打开电门
#define ELE_SWT_OFF_GPIO 21 //关闭电门

#define SPK_OUT_GPIO	41//音频输出
//外电控制
#define EXBAT_CONTROL_GPIO  50

//中断为GPIO_EINT_NO_USE的可以省略
//acc
#define ACC_EINT_NO             21
//SOS按键
#define EXTRA_SOS_EINT_NO       GPIO_EINT_NO_USE
//尾线检测中断
#define EXTRA_IN_1_EINT_NO        2//检测涨闸状态
...
#define EINT_B_NO  EXTRA_IN_1_EINT_NO
#define EINT_C_NO  EXTRA_IN_2_EINT_NO
#define EINT_D_NO  GPIO_EINT_NO_USE

/*3、中断对应的IO 口*/
#define EINT_A_GPIO 48
