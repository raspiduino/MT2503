...
{
    my ($bb) = @_;
    my ($strTSMMDumpSize,$strAPDspramBakSize,$strAPIntsramBakSize,$strTSLogSize,$strTSResEmiSize,$strCSCIInfoSize) = (undef,undef,undef,undef,undef,undef);
    my %BB_TS_ResMem_tbl =
       (        #[MAX_TS_MM_DUMP_SIZE, MAX_AP_DSPRAM_BAK_SIZE,MAX_AP_INTSRAM_BAK_SIZE,MAX_TS_LOGGING_SIZE,MAX_TS_RES_EMI_SIZE,MAX_CSCI_INFO_SIZE]
                'MT6260' => ["0xFC00","0xB400","0x3000","0x2800","0xB400","0x6800"],
                'MT6261' => ["0xFC00","0xB400","0x3000","0x2800","0x0", "0x6800"],
                'MT2501' => ["0xFC00","0xB400","0x3000","0x2800","0x0", "0x6800"],
                'MT2502' => ["0xFC00","0xB400","0x3000","0x2800","0x0", "0x6800"],
       );
    if(exists $BB_TS_ResMem_tbl{$bb})
    {
        $strTSMMDumpSize     = $BB_TS_ResMem_tbl{$bb}[0];
        $strAPDspramBakSize  = $BB_TS_ResMem_tbl{$bb}[1];
        $strAPIntsramBakSize = $BB_TS_ResMem_tbl{$bb}[2];
        $strTSLogSize        = $BB_TS_ResMem_tbl{$bb}[3];
        $strTSResEmiSize     = $BB_TS_ResMem_tbl{$bb}[4];
        $strCSCIInfoSize     = $BB_TS_ResMem_tbl{$bb}[5];
    }
    return ($strTSMMDumpSize,$strAPDspramBakSize,$strAPIntsramBakSize,$strTSLogSize,$strTSResEmiSize,$strCSCIInfoSize);
}
...
sub GetTS_DspramInfo
{
    ...
    (
        ...
        #'MT6260' => ["",""],                                        #use EMI to simulate DSPRAM
...
sub GetIntsramInfo
{
    ...
    my %BB_INTSRAM_tbl =
       (        # $bb => [INTSRAM_CODE_Base, INTSRAM_CODE_Size, INTSRAM_DATA_Base, INTSRAM_DATA_Size]
                ...
                'MT2501'  => ["0x70008000", "0x00001200", "0x70009200", "0x00000E00"], #MT6261
                'MT2502'  => ["0x70008000", "0x00001200", "0x70009200", "0x00000E00"], #MT6261
