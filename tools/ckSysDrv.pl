...
sub check_rsv_sectors_FDM50
{
    ...
    elsif($FDM5_Support > 0 && $TotalBlks >= 128)
    {
        ...
        # FAT size too large causes $TblBlks=42 and errror
        #print("\n\nfat test $fat_space_size=%d,$DataBlks=%d,$TblBlks=%d,$TotalBlks=%d,$nor_sector_size=%d \n",$fat_space_size,$DataBlks,$TblBlks,$TotalBlks,$nor_sector_size);
